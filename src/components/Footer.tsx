...
const Footer: React.FC = () => {
  ...
  return <footer className="bg-background border-t border-border py-12 px-4" role="contentinfo">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {mainLinks.map(link => <li key={link.path}>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {legalLinks.map(link => <li key={link.path}>
                  <Link to={link.path} className="text-muted-foreground hover:text-foreground transition-colors">
                    {link.label}
                  </Link>
                </li>)}
