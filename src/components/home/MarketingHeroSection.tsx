...
import { ArrowRight, ChevronDown, Sparkles, Shield, Brain, Users, Star, Play, BookmarkPlus, Search, Zap } from 'lucide-react';
import { 
  Tooltip,
  TooltipContent,
  TooltipProvider,
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto text-center relative z-10">
        ...
        >
          <span className="inline-block">Never lose track of</span>
          ...
          <span className="bg-gradient-to-r from-white via-white/95 to-white/90 bg-clip-text text-transparent block relative">
            Your AI Knowledge Engine
          </span>
        </h1>
        
        {/* Value proposition */}
        <p className="text-lg md:text-xl lg:text-2xl text-white/95 mb-12 max-w-3xl mx-auto leading-relaxed">
          Transform scattered bookmarks, articles, and notes into an organized, searchable knowledge base. 
          Save anything, find everything instantly, and
          <span className="font-semibold text-white relative mx-2">
            achieve 10x productivity
          </span> 
          with intelligent AI organization.
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12 max-w-4xl mx-auto">
          <div className="flex flex-col items-center text-center p-6 bg-white/10 rounded-2xl backdrop-blur-sm">
            ...
            <p className="text-white/80 text-sm">Capture any webpage, article, or document with one click</p>
          </div>
          ...
          <div className="flex flex-col items-center text-center p-6 bg-white/10 rounded-2xl backdrop-blur-sm">
            ...
            <p className="text-white/80 text-sm">Smart categorization and tagging happens automatically</p>
          </div>
          ...
          <div className="flex flex-col items-center text-center p-6 bg-white/10 rounded-2xl backdrop-blur-sm">
            ...
            <p className="text-white/80 text-sm">Powerful search finds exactly what you need, when you need it</p>
          </div>
        </div>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  ...
                  >
                    ...
                    <span className="relative z-10">Start Building Your Knowledge Engine</span>
                ...
                <TooltipContent className="bg-white text-primary border-primary/20 shadow-xl">
                  <p className="font-medium">No credit card • Free forever plan • Ready in 30 seconds</p>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
          ...
          {showDemo && (
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 max-w-md" role="region" aria-labelledby="demo-heading">
              <div className="text-white/90 text-sm mb-4 text-center">
                <p id="demo-heading" className="font-semibold mb-3 text-lg">Watch Accio in action:</p>
                <div className="space-y-3 text-left">
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-green-400 rounded-full" aria-hidden="true"></div>
                    <span>Save any webpage with one click</span>
                  </div>
                  <div className="flex items-center gap-3">
        ...
        <div className="mt-20">
          ...
          >
            <span className="font-semibold text-xl relative">
              Discover the power of organized knowledge
            </span>
