...
const AIFeatures: React.FC = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      icon: Target,
      component: () => React.createElement(require('@/components/features/AILearningPathGenerator').AILearningPathGenerator),
      category: 'Learning'
    },
    {
      ...
      icon: BellRing,
      component: () => React.createElement(require('@/components/features/SmartNotifications').SmartNotifications),
      category: 'Productivity'
    },
    {
      id: 'summarizer',
  ...
  const categories = ['All', 'Interaction', 'Analysis', 'Search', 'Organization', 'Analytics', 'Productivity', 'Learning'];
