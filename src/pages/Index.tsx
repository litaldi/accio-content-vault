...
const Index = () => {
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <Helmet>
        <title>Accio - Stop Losing Brilliant Ideas. Reclaim 5+ Hours Weekly | AI Knowledge Management</title>
        <meta name="description" content="Join 50,000+ professionals using Accio's AI-powered knowledge engine. Transform scattered information into organized intelligence. Save 5+ hours weekly. Free forever plan available." />
        ...
        {/* Responsive viewport and performance optimizations */}
      ...
      <main className="flex-1" role="main">
        <div className="py-6 sm:py-12 space-y-12 sm:space-y-24">
          <HeroSection />
          <StatsSection />
          <EnhancedFeaturesSection />
          <TestimonialsSection />
