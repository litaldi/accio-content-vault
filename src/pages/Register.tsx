  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Create your Accio account and start organizing your knowledge today." />
      </Helmet>
      ...
      <div className="min-h-screen flex items-center justify-center py-12 px-4">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Join thousands of users organizing their knowledge with Accio
            </CardDescription>
          </CardHeader>
